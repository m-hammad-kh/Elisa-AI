...
// Multiple diverse footer templates
const FOOTER_TEMPLATES = [
  // Modern Dark with Grid Layout
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/about" className="text-slate-400 hover:text-white transition">Pricing</a></li>
              <li><a href="/docs" className="text-slate-400 hover:text-white transition">Documentation</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/contact" className="text-slate-400 hover:text-white transition">Blog</a></li>
              <li><a href="/" className="text-slate-400 hover:text-white transition">Careers</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-4">Legal</h4>
            <ul className="space-y-2">
              <li><a href="/privacy" className="text-slate-400 hover:text-white transition">Privacy</a></li>
              <li><a href="/terms" className="text-slate-400 hover:text-white transition">Terms</a></li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <span className="text-slate-600 text-xs">Built with Elisa AI</span>
          </div>
        </div>
      </div>
    </footer>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-slate-900 font-bold text-lg mb-4">Brand</h3>
            <p className="text-slate-600 text-sm">Creating modern digital experiences.</p>
          </div>
          <div>
            <h4 className="text-slate-900 font-semibold text-sm mb-4">Product</h4>
            <ul className="space-y-3"><li><a href="/" className="text-slate-600 text-sm hover:text-slate-900 transition">Home</a></li><li><a href="/about" className="text-slate-600 text-sm hover:text-slate-900 transition">About</a></li></ul>
          </div>
          <div>
            <h4 className="text-slate-900 font-semibold text-sm mb-4">Resources</h4>
            <ul className="space-y-3"><li><a href="/docs" className="text-slate-600 text-sm hover:text-slate-900 transition">Docs</a></li><li><a href="/contact" className="text-slate-600 text-sm hover:text-slate-900 transition">Contact</a></li></ul>
          </div>
          <div>
            <h4 className="text-slate-900 font-semibold text-sm mb-4">Legal</h4>
            <ul className="space-y-3"><li><a href="/privacy" className="text-slate-600 text-sm hover:text-slate-900 transition">Privacy</a></li><li><a href="/terms" className="text-slate-600 text-sm hover:text-slate-900 transition">Terms</a></li></ul>
          </div>
          <div>
            <h4 className="text-slate-900 font-semibold text-sm mb-4">Follow</h4>
            <ul className="space-y-3"><li><a href="/" className="text-slate-600 text-sm hover:text-slate-900 transition">Twitter</a></li><li><a href="/" className="text-slate-600 text-sm hover:text-slate-900 transition">LinkedIn</a></li></ul>
          </div>
        </div>
        <div className="border-t border-slate-200 pt-8 text-center text-slate-600 text-xs">
          <p>© {new Date().getFullYear()} Your Brand. Made with Elisa AI.</p>
        </div>
      </div>
    </footer>
  );
...
`,
  ...
  // Gradient Modern Footer
  `import React from "react";

const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-slate-900 to-slate-800 text-slate-100 py-16 border-t border-slate-700">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-white font-bold text-xl mb-2">Brand Name</h3>
            <p className="text-slate-400 text-sm leading-relaxed">Elevating digital experiences with cutting-edge design and technology.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/" className="text-slate-400 hover:text-white transition text-sm">Features</a></li>
              <li><a href="/about" className="text-slate-400 hover:text-white transition text-sm">Pricing</a></li>
              <li><a href="/docs" className="text-slate-400 hover:text-white transition text-sm">Documentation</a></li>
              <li><a href="/contact" className="text-slate-400 hover:text-white transition text-sm">Support</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-6">More</h4>
            <ul className="space-y-3">
              <li><a href="/about" className="text-slate-400 hover:text-white transition text-sm">About Us</a></li>
              <li><a href="/privacy" className="text-slate-400 hover:text-white transition text-sm">Privacy Policy</a></li>
              <li><a href="/terms" className="text-slate-400 hover:text-white transition text-sm">Terms</a></li>
              <li><a href="/" className="text-slate-400 hover:text-white transition text-sm">Sitemap</a></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-slate-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-slate-400 text-xs">
            <p>© {new Date().getFullYear()} All rights reserved. Powered by Elisa AI.</p>
          </div>
        </div>
      </div>
    </footer>
...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-slate-900 via-purple-900 to-slate-950 text-white py-16 border-t-2 border-purple-500">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Company</h3>
            <ul className="space-y-2">
              <li><a href="/about" className="text-slate-300 hover:text-purple-400 transition">About</a></li>
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Team</a></li>
              <li><a href="/contact" className="text-slate-300 hover:text-purple-400 transition">Contact</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4 text-purple-300">Services</h3>
            <ul className="space-y-2">
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Design</a></li>
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Development</a></li>
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Consulting</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4 text-pink-300">Legal</h3>
            <ul className="space-y-2">
              <li><a href="/privacy" className="text-slate-300 hover:text-pink-400 transition">Privacy</a></li>
              <li><a href="/terms" className="text-slate-300 hover:text-pink-400 transition">Terms</a></li>
              <li><a href="/" className="text-slate-300 hover:text-pink-400 transition">Cookies</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4 text-purple-300">Follow</h3>
            <ul className="space-y-2">
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Twitter</a></li>
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">Instagram</a></li>
              <li><a href="/" className="text-slate-300 hover:text-purple-400 transition">LinkedIn</a></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-slate-700 pt-8 text-center">
          <p className="text-slate-400 text-xs">© {new Date().getFullYear()} · Crafted with AI by Elisa</p>
        </div>
      </div>
    </footer>
  );
...
const getRandomFooter = () => FOOTER_TEMPLATES[Math.floor(Math.random() * FOOTER_TEMPLATES.length)];

// Footer generation instruction to be included in AI prompt
const FOOTER_GENERATION_INSTRUCTION = `

FOOTER GENERATION (CRITICAL):
- MUST include a Footer.jsx component in your response
- Footer design MUST match the website's color scheme and theme
- Do NOT always use dark backgrounds - use colors that fit the site's palette
- Create DIFFERENT footer styles for different website types:
  * Tech/SaaS: Modern dark or gradient footers
  * Lifestyle/Creative: Colorful, bold, branded footers  
  * Corporate: Clean, minimal, professional footers
  * E-commerce: Feature-rich footers with multiple sections
- Make each footer UNIQUE and VISUALLY DISTINCT from previous generations
- Include proper links, company info, and social media sections

IMAGES & MEDIA (CRITICAL):
- Use only pexels.com or picsum.photos for images
- ALWAYS wrap image URLs with solid color backgrounds as fallback:
  - For hero images: Use gradient backgrounds (e.g., bg-gradient-to-br from-blue-600 to-purple-800)
  - For cards: Use solid backgrounds (e.g., bg-slate-200, bg-blue-100, bg-green-100)
  - This ensures images load or solid colors display instantly
  - Example: style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%), url(...)"
- Never rely on images alone - always have a beautiful background color fallback

MAPS ON CONTACT PAGE (IMPORTANT):
- Include an iframe for Google Maps embed IF the page is a contact/location page
- Use this format: <iframe src="https://www.google.com/maps/embed?pb=..." width="100%" height="400" style="border:0;" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
- Make maps responsive and optional (user can customize the location)
`;
